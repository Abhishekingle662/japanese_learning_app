...
import { setModules } from '@/store/slices/learningSlice';
...
export default function LearnScreen() {
  ...
  const { modules } = useAppSelector((state) => state.learning);
  const { profile, streakCount } = useAppSelector((state) => state.user);
